...
valueDisplays.forEach((valueDisplay) => {
  ...
  let counter = setInterval(function() {
    ...
    if (startValue >= endValue) {
      // Change the condition to stop when startValue is equal to or greater than endValue
...
function openDonationCausesPage() {
  window.location.href = 'donationCausesMain.html';
}
